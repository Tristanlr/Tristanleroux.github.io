...
$(document).ready(function() {
    ...
    $('.scrollDown').click(function(){
      ...
      var ScrollPositionMain = $('main').offset().top;
      var scrollPosition = ScrollPositionMain - 50;
  
      var menuHeight = $('.menuFixed').outerHeight( true );
      var scrollWithMenuFixed = scrollPosition - menuHeight;
  
      $('html,body').animate({scrollTop: scrollWithMenuFixed}, 'slow');
    });
    


  consoleText(['Bienvenue sur ma page personnelle'], 'text',['white']);
